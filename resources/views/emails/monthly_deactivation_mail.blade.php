    ...
    <div
        ...
        <div style="background-color:#ffffff;padding:20px;border-radius:8px">
            ...
            <p style="font-size:1em;color:#555">
                We regret to inform you that your Star Pasture account has been deactivated due to non-payment of the
                monthly activation fee.
                To regain access and reactivate your account, please click the button below and complete the payment
                process.
            </p>
