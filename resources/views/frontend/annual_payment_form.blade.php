...
<head>
    ...
    <title>Star Pasture - Annual Payment</title>
                    ...
                    <div>
                        ...
                        <div class="login-main">
                            <form id="register-user" class="theme-form" method="POST"
                                action="{{ route('annual_payment.submit', ['email' => $encryptedEmail]) }}">
                                @csrf
                                <input type="hidden" id="stripe_pub_key" name="stripe_pub_key"
                                    value="{{ config('services.stripe.key') }}">
                                <div>
                                    <h4>Update your account payment</h4>
                                    <p>Enter your personal details to update an account</p>
