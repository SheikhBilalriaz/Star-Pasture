...
<section class="secBanner" style="background-image: url({{asset('frontend_assets/images/banner_bg.jpg')}})">
    <div class="container">
        <div class="banner_vc">
            ...
            <p>We are StarPasture the world's leading company. We are the home for music's greatest artists, innovators, and entrepreneurs.</p>
            <div class="bn_form">
                <form action="">
                    <div class="field">
                ...
                <div class="list_box">
                    ...
                    <div class="ctn">
                        ...
                        <div class="loct_price">
                            ...
                            <span class="loct"><span class="icon"><img src="{{ asset('frontend_assets/images/loct.png')}}" alt=""></span>Gelsenkirchen</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6">
                <div class="bw_box">
                    ...
                    <div class="ctn">
                        ...
                        <p>List Your Bnb, Hotel Resort, Apartment,Private Condo, Homestay Rental, And More Now To Make Sales.</p>
                        <div class="btns">
