        ...
        <nav class="navbar navbar-expand-xl p-0">
            ...
            <div class="xtra_links">
                ...
                @else
                    ...
                    <a href="{{ route('login') }}" class="btn-user btn_circle">
                        <img src="{{ asset('frontend_assets/images/user_icon.png') }}" alt="">
    ...
    $(document).ready(function() {
        ...
        $('.info_list ul').each(function(){
            ...
            if(lgt > 5) {
                ...
                $(this).parent('div').append('<a href="javascript:;" class="show_more"><span class="txt">Show More</span><span class="icon"><img src="{{asset('frontend_assets/images/show_icon.svg')}}" /></span></a>');
            }
        });
